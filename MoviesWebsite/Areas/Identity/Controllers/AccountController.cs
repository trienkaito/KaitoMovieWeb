...
using MoviesWebsite.Areas.Identity.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _logger.LogWarning(2, "Accout has been lock");
                    var user = await _userManager.Users
                        .FirstOrDefaultAsync(_ => _.Email == model.UserNameOrEmail
                            || _.UserName == model.UserNameOrEmail);
                    if(user != null)
                    {
                        ViewBag.LockTime = await _userManager.GetLockoutEndDateAsync(user);
                    }
                    return View("Lockout");
                }
                else
                {
                    ModelState.AddModelError("Cannot log in.");
                    return View(model);
                }
            }
            return View(model);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("New user succesfully add.");
                    ...
                    await _emailSender.SendEmailAsync(model.Email, 
                        ...
                        @$"You have sign a account on MovieWeb, 
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (remoteError != null)
            {
                ModelState.AddModelError(string.Empty, $"Error, cannot use this function: {remoteError}");
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                    ...
                    else 
                    {
                        ...
                        /*
                            info => user1 (mail1@abc.com)
                                 => user2 (mail2@abc.com)
                        */
                        ModelState.AddModelError(string.Empty, "Cannot link to your account, please use another account");
                        return View();
                    }
                }
                ...
                {
                    ModelState.AddModelError(string.Empty, "Doesn't support new account - There is an email different from the email from an external service");
                    return View();                    
                }
        ...
        public async Task<IActionResult> SendCode(SendCodeViewModel model)
        {
            ...
            var message = "Your authentication code is: " + code;
        ...
        public async Task<IActionResult> UseRecoveryCode(UseRecoveryCodeViewModel model)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "Wrong recover code.");
                return View(model);
            }
        }
