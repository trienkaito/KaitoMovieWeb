        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "nvarchar(255)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Slug = table.Column<string>(type: "nvarchar(512)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rate = table.Column<float>(type: "float(2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hiden = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Evaluate_Movie_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movie",
                        principalColumn: "MovieId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Evaluate_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Episode_Title_Slug",
                table: "Episode",
                columns: new[] { "Title", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Evaluate_MovieId",
                table: "Evaluate",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movie_GroupId",
                table: "Movie",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Movie_Title_Slug",
                table: "Movie",
                columns: new[] { "Title", "Slug" },
                unique: true);
