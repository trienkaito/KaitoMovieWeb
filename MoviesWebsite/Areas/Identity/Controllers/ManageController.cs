...
using MoviesWebsite.Areas.Identity.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ViewData["Messages"] =
                ...
                : message == ManageMessageId.Error ? "Have error."
                : message == ManageMessageId.AddPhoneSuccess ? "Add phone number successfully."
                : message == ManageMessageId.RemovePhoneSuccess ? "Remove phone number successfully."
                : "";
        ...
        {
            ViewData["Messages"] =
                message == ManageMessageId.RemoveLoginSuccess ? "Account link removed successfully."
                : message == ManageMessageId.AddLoginSuccess ? "Add account link successfully."
        ...
        public async Task<IActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError(string.Empty, "Error add phone number");
            return View(model);
        }
        //
        ...
        public async Task<IActionResult> EditProfileAsync(EditExtraProfileModel model)
        {
            ...
            if (model.Image != null)
            {
                var imageUrl = await _cloudinaryService.UploadToCloudinaryAsync(model.Image);
                if (string.IsNullOrEmpty(imageUrl.Url))
                {
                    _logger.LogWarning("Upload to Cloudinary failed");
                }
                else
                {
                    user.Avatar = imageUrl.Url;
                }
            }
